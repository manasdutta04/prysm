  ...
  const handleDownloadPDF = () => {
    ...
    try {
      ...
      const barData = [
        {
          label: "Positive",
          pct: data.summary.positiveSentiment,
          r: 34,
          g: 197,
          b: 94,
        },
        {
          label: "Negative",
          pct: data.summary.negativeSentiment,
          r: 239,
          g: 68,
          b: 68,
        },
        {
          label: "Neutral",
          pct: data.summary.neutralSentiment,
          r: 160,
          g: 160,
          b: 160,
        },
      ...
      const perfRows = [
        [
          "Satisfaction Score",
          `${data.metrics?.satisfactionScore ?? "—"} / 5.0`,
        ],
        ...
        [
          "Feedback Volume",
          String(data.metrics?.feedbackVolume ?? data.summary.totalFeedback),
        ],
      ];
      ...
      const matrixRows = [
        ...
        },
        {
          ...
          account: connectedAppsObj["Play Store"]?.isConnected
            ? connectedAppsObj["Play Store"]?.appId ||
              connectedAppsObj["Play Store"]?.appName ||
              "Connected"
            : "—",
        ...
        },
        {
          ...
          account: connectedAppsObj["App Store"]?.isConnected
            ? connectedAppsObj["App Store"]?.appId ||
              connectedAppsObj["App Store"]?.appName ||
              "Connected"
            : "—",
        ...
        },
        {
          source: "Twitter (X)",
          account:
            connectedAppsObj.X?.isConnected ||
            connectedAppsObj["X"]?.isConnected
      ...
      matrixRows.forEach((row, i) => {
        ...
        const truncatedAccount =
          accountStr.length > 45
            ? accountStr.substring(0, 42) + "..."
            : accountStr;
      ...
      if (data.positivePoints && data.positivePoints.length > 0) {
        data.positivePoints.forEach(({ point, mentions }) => {
          ...
          pdf.setFontSize(7.5);
          pdf.setTextColor(120, 120, 120);
          pdf.text(`${mentions} mentions`, W - margin, y + 3.5, {
            align: "right",
          });
          y += lines.length * 5 + 3;
        });
        ...
        {hasNoData ? (
          <div className="dashboard-onboarding-widget">
            <div className="onboarding-header">
              <Sparkles
                className="onboarding-icon text-brand"
                size={24}
                style={{ color: "#CCFF00" }}
              />
              <h3 className="onboarding-title">No Feedback Data Found</h3>
              <p className="onboarding-subtitle">
                Prysm hasn't ingested any feedback records for this timeframe
                yet. To start generating AI-driven sentiment insights, please
                connect an integration or upload a CSV file.
              </p>
            </div>
            ...
            <div className="onboarding-cards">
              <div className="onboarding-card">
                <div className="onboarding-card-header">
                  <div className="onboarding-card-icon-container">
                    <svg
                      viewBox="0 0 24 24"
                      className="w-5 h-5 fill-current text-brand"
                      style={{ color: "#CCFF00" }}
                ...
                <p className="onboarding-card-desc">
                  Link live channels including App Store, Play Store, X
                  (Twitter), or Gmail to scrape reviews in real-time.
                </p>
              ...
              <div className="onboarding-card">
                ...
                <p className="onboarding-card-desc">
                  Import any spreadsheet of customer logs or feedback surveys.
                  Drag and drop a CSV file to preview and insert.
                </p>
                ...
                <div className="matrix-quadrants">
                  <div className="matrix-quadrant critical">
                    ...
                    <div className="quadrant-meta">
                      High Urgency · {data.negativePoints?.[0]?.mentions || 0}{" "}
                      Mentions
                    </div>
                  </div>
                  ...
                  <div className="matrix-quadrant leverage">
                    ...
                    <div className="quadrant-meta">
                      High Impact · {data.positivePoints?.[0]?.mentions || 0}{" "}
                      Mentions
                    </div>
                  </div>
